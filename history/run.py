...
PROJECT_ID = 'astral-sunbeam-600'
SERVICE_ACCOUNT_EMAIL = '766106295283-mvbdl76eduioip1aa96u9b0h6d9kut4n@developer.gserviceaccount.com'
...
def runSyncQuery (service, projectId, datasetId='samples', timeout=0):
...
runSyncQuery(service, PROJECT_ID)
